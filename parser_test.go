...
func TestParse_Invoice(t *testing.T) {
...
func TestParse_SimplifiedInvoice(t *testing.T) {
...
func TestParse_ProFormaInvoice(t *testing.T) {
...
func TestParse_TransportDocument(t *testing.T) {
...
func TestParse_InvoiceWithForeignTaxRate(t *testing.T) {
...
func TestParse_TaxCorrectionDebitNote(t *testing.T) {
...
func TestParse_InvoiceIssuedUnderVATMarginScheme(t *testing.T) {
